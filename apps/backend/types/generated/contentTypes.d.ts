...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    show_programs: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    showFeatureImage: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiDistrictDistrict extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    main_district: Schema.Attribute.Enumeration<
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    host_EN: Schema.Attribute.Text;
    host_HK: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    title_HK: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_EN: Schema.Attribute.Text;
    footer_HK: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiHalfAnHourHalfAnHour extends Struct.CollectionTypeSchema {
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    menu: Schema.Attribute.Component<'ui.menu-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    seo_title: Schema.Attribute.String;
    Slider: Schema.Attribute.Component<'ui.slide', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMenuMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item: Schema.Attribute.Component<'ui.menu-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPopupPopup extends Struct.SingleTypeSchema {
  ...
  attributes: {
    allowURL: Schema.Attribute.String;
    content_EN: Schema.Attribute.RichText;
    content_HK: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
